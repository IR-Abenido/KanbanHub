...
use App\Http\Requests\Auth\User\FindUserOrUsers;
use App\Http\Requests\Auth\User\MarkAsRead;
...
class UserController extends Controller
{
    ...
    public function findUserOrUsers(FindUserOrUsers $request)
    {
        $userId = Auth::user()->id;
        $users = [];
    ...
    public function getUserNotifications()
    {
        ...
        $mappedNotifications = $notifications->map(function ($notification) {
            return match ($notification->type) {
                ...
                'App\Notifications\TaskAdded' => [
                    'type' => $notification->data['type'] ?? 'task_added',
                    'id' => $notification->id,
                    'taskName' => $notification->data['taskName'] ?? null,
                    'created_at' => $notification->created_at
                ],
                ...
                'App\Notifications\TaskListAdded' => [
