...
use App\Http\Requests\Workspace\ArchiveWorkspace;
use App\Http\Requests\Workspace\DeleteWorkspace;
use App\Http\Requests\Workspace\StoreWorkspace;
use App\Http\Requests\Workspace\UnArchiveWorkspace;
use App\Http\Requests\Workspace\UpdateWorkspace;
...
class WorkspaceController extends Controller
{
    ...
    public function update(UpdateWorkspace $request)
    {
        $user = Auth::user();
        $workspace = Workspace::with('owner', 'users')
            ->findOrFail($request->id);

        $this->authorize('updateWorkspace', $workspace);
    ...
    public function archive(ArchiveWorkspace $request)
    {
        $workspace = Workspace::findOrFail($request->id);

        $this->authorize('archiveWorkspace', $workspace);
    ...
    public function unarchive(UnArchiveWorkspace $request)
    {
        $workspace = Workspace::findOrFail($request->id);

        $this->authorize('unArchiveWorkspace', $workspace);
    ...
    public function destroy(DeleteWorkspace $request)
    {
        $workspace = Workspace::findOrFail($request->id);
