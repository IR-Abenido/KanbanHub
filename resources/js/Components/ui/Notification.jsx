    ...
    const renderContent = () => {
        switch (notification?.type) {
            ...
            case 'task_added':
                return (
                    <Typography variant="paragraph" className="text-gray-600">
                        The task <span className="font-semibold">{notification.taskName}</span> has been added in the board <span className="font-semibold">{notification.boardName}</span>
                    </Typography>
                );
            case 'task_removed':
                return (
                    <Typography variant="paragraph" className="text-gray-600">
                        The task <span className="font-semibold">{notification.taskName}</span> has been removed
                    </Typography>
                );
            case 'task_restored':
                return (
                    <Typography variant="paragraph" className="text-gray-600">
                        The task <span className="font-semibold">{notification.taskName}</span> has been restored
                    </Typography>
                );
            ...
            case 'list_added':
                return (
                    <Typography variant="paragraph" className="text-gray-600">
                        A new list <span className="font-semibold">{notification.listName}</span> has been created from the board <span className="font-semibold">{notification.boardName}</span> has been restored
                    </Typography>
                );
            default:
                return null;
