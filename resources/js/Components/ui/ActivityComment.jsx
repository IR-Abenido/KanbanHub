    ...
    const editor = useEditor({
        extensions: [
            StarterKit.configure({
                ...
                code: {
                    HTMLAttributes: {
                        class: 'px-1.5 py-0.5 bg-gray-100 text-green-600 rounded font-mono text-sm'
                    }
                }
            }),
        ],
                    ...
                    <div>
                        <div
                            ...
                            dangerouslySetInnerHTML={{
                                __html: generateHTML(activity.activityDetails.content, [StarterKit.configure({
                                    bold: {
                                        HTMLAttributes: {
                                            class: 'font-bold',
                                        },
                        ...
                        <div className="flex items-center gap-1 mt-1">
                            ...
                            {!confirmDelete ?
                                (
                                    <>
                                        {(activity.userDetails.id === user.id) && (
                                            <>
                                                <Button
                                                    variant="text"
                                                    color="gray"
                                                    className="p-0 text-xs font-medium hover:bg-transparent hover:underline"
                                                    onClick={toggleEdit}
                                                >
                                                    Edit
                                                </Button>
