...
export default function TaskActivities({ task, activities, setActivities, refreshFiles }) {
    ...
    const canInteract = (workspaceRole !== 'member' ||
        boardRole === 'owner' ||
        boardRole === 'admin' ||
        boardRole === 'member');;
    ...
    return (
        <div
            className="h-full w-full flex flex-col mt-2">
                ...
                <div className="flex flex-row items-center gap-2 justify-between">
                    ...
                    {showActions ?
                        <Button
                            variant="gradient"
                            color="indigo"
                            className="p-0 py-3 flex items-center
                            justify-center text-[0.6rem] h-4 w-20
            ...
            >
                ...
                <div className="h-[50vh]">
                    <Virtuoso
                        ...
                        computeItemKey={(index) => filteredActivities[index].id}
                        itemContent={(index) => {
                            ...
                            switch (activity.activityDetails?.type) {
                                case 'action':
                                    return <ActivityAction activity={activity} />;
                                case 'comment':
                                    return (
                                        <ActivityComment
                                            activity={activity}
                                ...
                                case 'attachment':
                                    return <ActivityAttachment activity={activity} />;
                                default:
                                    return null;
                            }
                        }}
