...
export const boardSlice = createSlice({
    ...
    reducers: {
        ...
        addTask(state, action) {
            const existingList = state.lists.find(list => list.id === action.payload.listId);
            if (existingList) {
                const existingTask = existingList.tasks.find(task => task.id === action.payload.id);
                if (!existingTask) {
        ...
        removeTask(state, action) {
            ...
            if (existingList) {
                existingList.tasks = existingList.tasks.filter(task => task.id !== action.payload.taskId);
            }
        },
